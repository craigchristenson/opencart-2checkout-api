      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><input type="text" name="twocheckout_public_key" value="<?php echo $twocheckout_public_key; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_private_key; ?></td>
            <td><input type="text" name="twocheckout_private_key" value="<?php echo $twocheckout_private_key; ?>" /></td>
          </tr>
          <tr>
