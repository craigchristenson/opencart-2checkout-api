...
class ControllerPaymentTwoCheckout extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['twocheckout_public_key'])) {
            $this->data['twocheckout_public_key'] = $this->request->post['twocheckout_public_key'];
        } else {
            $this->data['twocheckout_public_key'] = $this->config->get('twocheckout_public_key');
        }

        if (isset($this->request->post['twocheckout_private_key'])) {
            $this->data['twocheckout_private_key'] = $this->request->post['twocheckout_private_key'];
        } else {
            $this->data['twocheckout_private_key'] = $this->config->get('twocheckout_private_key');
        }
